...
export const navigation: NavigationGroup = { id:'integrations', label:'Integrações', icon:Plug, order:80, items:[
  ...
  {to:'/cloud-sync',label:'Central de Sincronização',icon:Cloud,color:'blue',permission:'settings.manage'}, {to:'/cloud-connect',label:'Proton e Google Drive',icon:CloudCog,color:'purple',permission:'settings.manage'}, {to:'/app-center',label:'Central de Aplicativos',icon:Grid2X2,color:'purple'},
]}
