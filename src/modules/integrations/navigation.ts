import { AddressBook, Cable, Cloud, CloudCog, Grid2X2, Plug } from 'lucide-react'
...
export const navigation: NavigationGroup = { id:'integrations', label:'Integrações', icon:Plug, order:80, items:[
  ...
  {to:'/contacts-sync',label:'Sincronizar Contatos',icon:AddressBook,color:'blue',permission:'integrations.manage'},
